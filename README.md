...
- 2장. 객체 생성과 파괴
  ...
  - [ ] 5. [자원을 직접 명시하지 말고 의존 객체 주입을 사용하라](2장/[아이템_05]자원을_직접_명시하지_말고_의존_객체_주입을_사용하라.md) (조유리)
  - [ ] 6. [불필요한 객체 생성을 피하라](2장/[아이템_06]불필요한_객체_생성을_피하라.md) (조유리)
...
- 3장. 모든 객체의 공통 메서드
  ...
  - [ ] 10. [equals는 일반 규약을 지켜 재정의하라](2장/[아이템_10]equals는_일반_규약을_지켜_재정의하라.md) (윤우상)
  - [ ] 11. [equals를 재정의하려거든 hashCode도 재정의하라]() (조유리)
